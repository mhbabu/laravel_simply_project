    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                return '<a href="'.route('admin.products.destroy', $data->id).'" table="product-table" class="btn btn-sm btn-danger action-delete" title="Delete"><i class="fa fa-trash"></i> Delete</a> ';
            })
